...
const deleteAllGameDiffSets = `-- name: DeleteAllGameDiffSets :exec
DELETE FROM game_difficulty_settings
`

func (q *Queries) DeleteAllGameDiffSets(ctx context.Context) error {
	_, err := q.exec(ctx, q.deleteAllGameDiffSetsStmt, deleteAllGameDiffSets)
	return err
}
